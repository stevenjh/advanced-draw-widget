//>>built
define(["dojo/_base/declare", "dojo/has", "./kernel", "require"], function(b, c, d) {
    return b(null, {
        ...
        add: function(a) {
            ...
            this._historyStack.splice(this.position,
                0, a);
            this.position++;
            this.clearRedo();
            this.onAdd();
        ...
        peekUndo: function() {
            if (0 < this._historyStack.length && 0 < this.position) return this.get(this.position -
                1)
        },
        peekRedo: function() {
