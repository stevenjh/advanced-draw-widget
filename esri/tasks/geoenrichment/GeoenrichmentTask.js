//>>built
define(["../../declare", "dojo/_base/array", "dojo/dom-construct", "./taskHelper", "../FeatureSet", "./EnrichParameters", "./ReportParameters", "../../IdentityManager", "../../geometry/Point", "../../geometry/Polygon", "../../geometry/Polyline", "dojo/i18n!../../nls/jsapi"], function(r, s, g, d, t, k, l, u, v, w, x, h) {
    function m(a) {
        this.name = "UserError";
        this.message = a || ""
    }
    ...
    return r("esri.tasks.geoenrichment.GeoenrichmentTask", null, {
        ...
        getReports: function(a) {
            var b = this;
            return n(this, a).then(function(a) {
        ...
        getCountries: function(a) {
            ...
            switch (a.type) {
                ...
                case "polyline":
                    ...
                    break;
                case "polygon":
                    b = a.rings[0], a = new w(a.spatialReference), a.addRing(b), b = p(a)
            }
            return this.enrich({
