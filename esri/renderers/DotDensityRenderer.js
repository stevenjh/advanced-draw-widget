//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/dom-construct", "dojo/has", "../kernel", "./Renderer", "../symbols/PictureFillSymbol", "../geometry/ScreenPoint", "../geometry/Point"], function(n, p, q, u, v, r, s, t, m) {
    return n(r, {
        ...
        getSymbol: function(a) {
            ...
            this._map || (this._map = a.getLayer()._map,
                this._objectIdField = a.getLayer().objectIdField, this._currentMapScale = this._map.getScale(), this._currentResolution = this._map.extent.getWidth() / this._map.width, this._map.on("zoom-end", p.hitch(this, function(a) {
            ...
            if (this._symbolMap[this._currentMapScale] && this._symbolMap[this._currentMapScale][a.attributes[this._objectIdField]]) return b = this._symbolMap[this._currentMapScale][a.attributes[this._objectIdField]],
                c = this._getShapeProperties(a), b.setOffset(c.dx, c.dy), b;
            b = this._generateFieldsCount(this.fields, a.attributes, this.dotValue);
            c = this._getShapeProperties(a);
            b = new s(this._generateImageSrc(c.width, c.height, b, c.minXY, c.maxXY), this.outline, c.width, c.height);
            b.setOffset(c.dx, c.dy);
            this._symbolMap[this._currentMapScale] || (this._symbolMap[this._currentMapScale] = {});
            return this._symbolMap[this._currentMapScale][a.attributes[this._objectIdField]] = b
        },
        _generateFieldsCount: function(a, b, c) {
            var e, d;
            for (d = a.length -
                1; 0 <= d; d--) e = b[a[d].name] / c, a[d].numPoints = Math.round(e);
            return a
        },
        ...
        _generateImageSrc: function(a, b, c, e, d, f) {
            ...
            for (f = c.length - 1; 0 <= f; f--) {
                ...
                for (l = c[f].numPoints - 1; 0 <= l; l--) h = this._getRandomPoint(a, b, e, d), "square" === this.dotShape ? g.fillRect(h.x, h.y, k, k) : "circle" === this.dotShape && (g.beginPath(), g.arc(h.x,
                    h.y, k / 2, 0, 2 * Math.PI, !0)), g.fill()
            }
            return this._canvas.toDataURL()
        },
        _initCanvas: function(a, b) {
            var c = q.create("canvas", {
                id: "canvas",
                width: a + "px",
                height: b + "px",
        ...
        _getRandomPoint: function(a, b, c, e) {
            ...
            if (!0 === this.exactCount && a * b > this._exactCountMinArea) {
                do d.x = this._getRandomInt(c.x,
                    e.x), d.y = this._getRandomInt(e.y, c.y), a = new t(d.x, d.y), a = this._checkPointShapeBounds(a, this.dotSize + f, this._currentGraphic.geometry), !0 === a && (d.x -= c.x, d.y -= e.y); while (!1 === a)
