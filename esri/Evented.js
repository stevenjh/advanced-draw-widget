    ...
    return m([n], {
        ...
        on: function(d, c) {
            ...
            var a = this.constructor._onMap || this.registerConnectEvents(),
                ...
                g = a && a[e];
            return (f = g && g.method || this[f] && h.isFunction(this[f]) && f) ? g && h.isArray(g.argKeys) ? (a = this._onArr2Obj(c, a[e].argKeys), l.after(this, f, a, !0)) : l.after(this, f, c, !0) : this.inherited(arguments)
        },
        emit: function(d, c) {
        ...
        _hyphenLower: function(d) {
            return d.replace(/^on/, "").replace(/[A-Z](?=[a-z])/g, function(c,
                a) {
